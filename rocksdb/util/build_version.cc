...
static const std::string rocksdb_build_git_sha  = "rocksdb_build_git_sha:cc3d315c781eae8d648d2719e78f535f806f51e0";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:scheduling";
#define HAS_GIT_CHANGES 1
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2023-07-31 12:59:28";
#else
// If HAS_GIT_CHANGES is > 0, the branch/tag has modifications.
// Use the time the build was created.
static const std::string rocksdb_build_date = "rocksdb_build_date:2023-09-04 16:16:27";
#endif
