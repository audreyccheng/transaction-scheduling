...
//       System.out.println("[" + Transactions.WRITE_CHECK+ "] End");
      ...
      trx = GenerateConsolidateTransaction();
      nbAborts = trx.run();
      end = System.currentTimeMillis();
  ...
  public ConsolidateTransaction GenerateConsolidateTransaction() {
    int custId1 = generateCustomerAccount();
    int custId2 = custId1;
    while (custId2==custId1) {
      custId2 = generateCustomerAccount();
    }
    return new ConsolidateTransaction(this,custId1, custId2, txn_id++);
  }
