...
public class SmallBankLoader {
  ...
  public static void loadData(SmallBankExperimentConfiguration smallBankConfig, String expConfigFile)
           ...
           for (int ij = 0; ij < 10; ij++) {
             ...
             if (custId>= end)
               ...
               accountsTable.updateColumn("A_DATA",
                   ...
                   row);
               client.write(SmallBankConstants.kAccountsTable, custId.toString(), row);
               ...
               savingsTable.updateColumn("S_BAL",
                   Generator.getGaussian(config.MIN_BALANCE, config.MAX_BALANCE), row);
               client.write(SmallBankConstants.kSavingsTable, custId.toString(), row);
               ...
               checkingsTable.updateColumn("C_DATA",
                   generator.RandString(config.VAR_DATA_SIZE / 2, config.VAR_DATA_SIZE, false),
                   row);
               client.write(SmallBankConstants.kCheckingsTable, custId.toString(), row);
             }
