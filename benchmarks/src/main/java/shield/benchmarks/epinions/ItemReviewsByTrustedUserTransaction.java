...
public class ItemReviewsByTrustedUserTransaction extends BenchmarkTransaction {
    private EpinionsExperimentConfiguration config;
    private int iid;
    private int uid;
    private long txn_id;

    public ItemReviewsByTrustedUserTransaction(EpinionsGenerator generator, int iid, int uid, long txn_id) {
        this.iid = iid;
        this.uid = uid;
        this.txn_id = txn_id;
...
//            System.out.println("AverageRatingByTrustedUserTransaction");
            ...
            results = client.readAndExecute(EpinionsConstants.kReviewByIIDTable,
                    Integer.toString(iid)); //, EpinionsConstants.Transactions.ITEMREVIEWTRUSTEDUSER.ordinal(), this.txn_id);
            ...
            client.readAndExecute(EpinionsConstants.kTrustTable, Integer.toString(uid)); //,
                    // EpinionsConstants.Transactions.ITEMREVIEWTRUSTEDUSER.ordinal(), this.txn_id);
